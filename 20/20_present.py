...
def parse_tile(s):
  ...
  tile = list(map(list, lines[1:])) # string[] -> char[][]
  return tile_id, tile
...
"""
tile   borders             normalized_borders

123    123,147,789,369     123,147,789,369
456  
789  

741    741,789,963,123     123,147,789,369
852  
963  

963    963,987,741,321     123,147,789,369
852
741
...
# return min(border, reversed(border))
